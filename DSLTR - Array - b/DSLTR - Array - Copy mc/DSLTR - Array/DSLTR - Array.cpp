...
void insertionSort(vector<NutrientsInfo>& data, bool ascending) {
    int n = data.size();
...
//            switch (column) {
//            case 1:  // Sorting based on food name
//                if ((ascending && data[j].food > data[j + 1].food) ||
//                    (!ascending && data[j].food < data[j + 1].food)) {
//                    swap(data[j], data[j + 1]);
//                }
//                break;
//            case 2:  // Sorting based on measure
//                if ((ascending && data[j].measure > data[j + 1].measure) ||
//                    (!ascending && data[j].measure < data[j + 1].measure)) {
//                    swap(data[j], data[j + 1]);
//                }
//                break;
//            case 3:  // Sorting based on grams
//                if ((ascending && data[j].grams > data[j + 1].grams) ||
//                    (!ascending && data[j].grams < data[j + 1].grams)) {
//					swap(data[j], data[j + 1]);
//				}
//                break;
//            case 4:  // Sorting based on calories 
//                if ((ascending && data[j].calories > data[j + 1].calories) ||
//                    (!ascending && data[j].calories < data[j + 1].calories)) {
//					    swap(data[j], data[j + 1]);
//				    }
//                break;
//            case 5:  // Sorting based on protein
//                if ((ascending && data[j].protein > data[j + 1].protein) ||
//                    (!ascending && data[j].protein < data[j + 1].protein)) {
//                    swap(data[j], data[j + 1]);
//                }
//                break;
//            case 6:  // Sorting based on fat
//                if ((ascending && data[j].fat > data[j + 1].fat) ||
//                    (!ascending && data[j].fat < data[j + 1].fat)) {
//					swap(data[j], data[j + 1]);
//				}
//                break;
//            case 7:  // Sorting based on saturated fat
//                if ((ascending && data[j].satFat > data[j + 1].satFat) ||
//                    (!ascending && data[j].satFat < data[j + 1].satFat)) {
//                    swap(data[j], data[j + 1]);
//                }
//                break;
//            case 8:  // Sorting based on fiber
//                if ((ascending && data[j].fiber > data[j + 1].fiber) ||
//                    (!ascending && data[j].fiber < data[j + 1].fiber)) {
//					swap(data[j], data[j + 1]);
//				}
//                break;
//            case 9:  // Sorting based on carbs
//                if ((ascending && data[j].carbs > data[j + 1].carbs) ||
//                    (!ascending && data[j].carbs < data[j + 1].carbs)) {
//					swap(data[j], data[j + 1]);
//				}
//                break;
//                // ... (similar cases for other columns)
//            case 10: // Sorting based on category
//                if ((ascending && data[j].category > data[j + 1].category) ||
//                    (!ascending && data[j].category < data[j + 1].category)) {
//                    swap(data[j], data[j + 1]);
//                }
//                break;
//            }
